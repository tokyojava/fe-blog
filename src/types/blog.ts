...
export const CreateOrUpdateBlogZodSchema = z.object({
    title: z.string()
    ...
    category: z.array(z.string(), "Category cannot be empty"),
    type: z.enum(['blog', 'diary'], "Type must be either 'Blog' or 'Diary'"),
});

export type CreateOrUpdateBlogRequest = z.infer<typeof CreateOrUpdateBlogZodSchema>;
